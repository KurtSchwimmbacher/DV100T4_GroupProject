...
//           <div class="style2">
//             <div class="col-md-4 "> 
//               <img src="../assets/indie movie 1.2.jpg" class="imagemovie11" alt="...">
//             </div>         
//           </div>
//          <div class="style3">
//           <button class="remove1"></button>
//           <div class="col-md-8">               
//             <div class="card-body">
//               <h5 class="card-title2" style="margin-bottom: 20px; font-size:x-large; font-weight: 400; font-family:'Dosis', sans-serif;" id="title">The green knight</h5>            
//               <p class="card-text2" id="description2">7.9/10 IMDB</p>
//               <button class="upvote1"></button>
//               <button class="downvote1"></button>           
//             </div>
